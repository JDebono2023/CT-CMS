...
class RecentContents extends Component
{
    use WithPagination;

    public $recentMedia, $media, $modelId, $catId, $user_file_name, $file_name, $store_id, $store_name, $starts_at, $ends_at, $edits, $device, $edit_text, $email, $cat, $mediaRequest, $no_end, $thumb, $order_number, $confirm, $type_id;
    ...
    {
        $this->recentMedia = media::with('category')->latest()->orderBy('updated_at', 'asc')->limit(12)->get();
        // dd($this->recentMedia);
        ...
        $this->recentMedia = media::with('category')
        ...
        return view('livewire.recent-contents', ['recentMedia' => $this->recentMedia, 'store_id' => $this->store_id, 'cTypeList' => $cTypeList, 'store_name' => $this->store_name, 'category' => $this->category,]);
    }
}
